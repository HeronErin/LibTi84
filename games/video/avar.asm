...
;../../src/graphics.c:186: }
	ret
;appVar.c:14: void nullcp(char* to, char* from){
;	---------------------------------
; Function nullcp
; ---------------------------------
_nullcp::
	...
	add	ix,sp
	push	af
;appVar.c:15: for (int i =0; i < 10; ++i){
	ld	bc, #0x0000
00105$:
	ld	a, c
	sub	a, #0x0a
...
;appVar.c:20: }
	...
	pop	ix
	ret
;appVar.c:21: unsigned int make(short size, char* name){
;	---------------------------------
; Function make
; ---------------------------------
_make::
	...
	ld	ix,#0
	add	ix,sp
;appVar.c:23: nullcp((char*)(0x8478), name);
	ld	l, 6 (ix)
	ld	h, 7 (ix)
	push	hl
	ld	hl, #0x8478
	...
	pop	af
	pop	af
;appVar.c:28: __endasm;
	ld	l, 4 (ix)
	ld	h, 5 (ix)
;appVar.c:32: bcall(0x4E6A);
	rst	40 
	.dw 0x4E6A 
;appVar.c:36: __endasm;
	ld	l, d
	ld	h, e
;appVar.c:39: }
	pop	ix
	ret
;appVar.c:40: int getInfo(char* name){
;	---------------------------------
; Function getInfo
; ---------------------------------
_getInfo::
	...
	ld	ix,#0
	add	ix,sp
;appVar.c:42: nullcp((char*)(0x8478), name);
	ld	l, 4 (ix)
	ld	h, 5 (ix)
	push	hl
	ld	hl, #0x8478
	...
	pop	af
	pop	af
;appVar.c:43: char br = name[0];
	ld	c, 4 (ix)
	ld	b, 5 (ix)
	ld	a, (bc)
;appVar.c:45: bcall(0x42F1);
	rst	40 
	.dw 0x42F1 
;appVar.c:48: __endasm;
	ld	a, b
;appVar.c:50: if (br != 0)
	or	a, a
	jr	Z,00102$
;appVar.c:51: return br;
	ld	l, a
	ld	h, #0x00
	jr	00104$
00102$:
;appVar.c:56: __endasm;
	ld	h, d
	ld	l, e
00104$:
;appVar.c:59: }
	pop	ix
	ret
;appVar.c:60: void archiveToggle(char* name){	
;	---------------------------------
...
_archiveToggle::
	...
	ld	ix,#0
	add	ix,sp
;appVar.c:61: nullcp((char*)(0x8478), name);
	ld	l, 4 (ix)
	ld	h, 5 (ix)
	push	hl
	ld	hl, #0x8478
	...
	pop	af
	pop	af
;appVar.c:62: bcall(0x4FD8);
	rst	40 
	.dw 0x4FD8 
;appVar.c:63: }
	pop	ix
	ret
;appVar.c:64: void main() {
;	---------------------------------
; Function main
; ---------------------------------
_main::
;appVar.c:68: init_graphics();
	call	_init_graphics
